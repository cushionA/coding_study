 ...
 *
 * ★ unit07 の lesson/_dom.ts と同じ内容です(コピーして持ってきています)。
 *   "jsdom" モジュールの型宣言は unit07-react-ui/lesson/jsdom.d.ts が
 *   プロジェクト全体に対して行っているので、ここでは再宣言しません
 *   (同じ ambient 宣言を2回書くと「重複した識別子」で怒られます)。
 * ===================================================================== */
