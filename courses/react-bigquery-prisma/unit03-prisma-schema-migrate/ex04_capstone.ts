...
import { PrismaClient, type Book } from "./prisma/generated/prisma/client.js";
...
export function createPrismaClient(dbFilePath: string): PrismaClient {
  // TODO: `new PrismaBetterSqlite3({ url: \`file:${dbFilePath}\` })` でアダプタを作り、
  // `new PrismaClient({ adapter })` の形でクライアントを組み立てて返す
